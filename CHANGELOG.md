...
### Fixed
- **iOS Build Error**: Fixed platform detection in CMakeLists.txt to correctly identify iOS builds. Previously, iOS builds were being detected as macOS, causing the wrong Rust target to be used and resulting in linker errors.
